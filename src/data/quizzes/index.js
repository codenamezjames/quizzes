...
export const quizManifest = [
  ...
  {
    id: 'jjk-characters',
    title: 'JJK Characters',
    description: 'How well do you know the cast of Jujutsu Kaisen?',
    icon: 'people',
    category: 'jujutsu-kaisen',
    coverColor: '#283593',
    loader: () => import('./jjk-characters.json'),
  },
  {
    id: 'jjk-techniques',
    title: 'JJK Techniques & Domains',
    description: 'Domain expansions, cursed techniques, and Black Flash!',
    icon: 'auto_fix_high',
    category: 'jujutsu-kaisen',
    coverColor: '#4527A0',
    loader: () => import('./jjk-techniques.json'),
  },
  {
    id: 'jjk-curses',
    title: 'JJK Cursed Spirits & Villains',
    description: 'Sukuna, Mahito, Kenjaku and the demons of JJK!',
    icon: 'skull',
    category: 'jujutsu-kaisen',
    coverColor: '#311B92',
    loader: () => import('./jjk-curses.json'),
  },
  {
    id: 'jjk-shibuya',
    title: 'JJK Shibuya Incident',
    description: 'The pivotal Shibuya arc — Halloween night!',
    icon: 'location_city',
    category: 'jujutsu-kaisen',
    coverColor: '#B71C1C',
    loader: () => import('./jjk-shibuya.json'),
  },
  {
    id: 'jjk-clans-schools',
    title: 'JJK Clans & Schools',
    description: 'Big Three Clans, jujutsu high schools, and the Culling Game!',
    icon: 'school',
    category: 'jujutsu-kaisen',
    coverColor: '#1B5E20',
    loader: () => import('./jjk-clans-schools.json'),
  },
